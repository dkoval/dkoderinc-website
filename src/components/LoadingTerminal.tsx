  ...
  return (
    <div className="absolute inset-0 flex flex-col p-4 font-mono text-sm">
      <div className="flex items-center gap-2 text-green-400 mb-2">
        ...
        <span>loading_image.sh</span>
      </div>
      <div className="text-green-400 typewriter-effect">
        <p>$ loading profile image...</p>
        <p className="mt-1">[====================] 100%</p>
        <p className="mt-1 text-yellow-400">chmod 644 dmytro_koval_headshot.jpg</p>
        <p className="mt-1 text-blue-400">cat dmytro_koval_headshot.jpg &gt; /dev/display</p>
